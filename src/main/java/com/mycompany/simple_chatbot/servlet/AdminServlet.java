...
public class AdminServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Account> accountList = accDbService.fetchAllUsers();
        request.setAttribute(StringConstants.ATTRIBUTE_ACCOUNTS_LIST, accountList);
        request.getRequestDispatcher(StringConstants.ADMIN_PAGE).forward(request, response);
